...
| Asset | Spec | Status |
|---|---|---|
| App icon | 512 × 512 PNG, 32-bit | **Exists** — generated by `flutter_launcher_icons`, see the three yaml files at the repo root |
| Feature graphic | 1024 × 500 PNG or JPEG, no alpha | **Not made.** Needed before any track goes public. |
| Phone screenshots | min 4, max 8 | See below |
...
Reference captures of shots 1–5 and 7 exist and confirm each screen is worth
shooting as listed. Shot 6 (compatibility) needs a partner's details entered
first, so it cannot be captured cold.
...
- [ ] Feature graphic (1024 × 500) — needs a designer or a template
- [ ] Capture and letterbox the eight screenshots, three times
